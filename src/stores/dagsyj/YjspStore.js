...
class YjspStore extends BaseStore {
 ...
 // @observable reportName="Blank_A4_1";
  ...
  @action reportPrint = async (id) => {
    ...
    let urls = "/api/eps/control/main/yjsp/queryReport?id=" + id;
  ...
  //    let data1 = response.data.message;
   ...
   //   let param = {};
      ...
      const ip = "localhost:8180"
    //  this.printshow=true;


      axios({ // 用axios发送post请求
        method: 'post',
        url: 'http://localhost:8180/offline/report/apiMap/print/'+this.reportName, // 请求地址
        data: this.param // 参数
...
export default new YjspStore('/api/eps/control/main/gszxyjsqd', true, true);
