...
class DayjgzcltjStore extends BaseStore {
    ...
    @action queryForPage = async () => {
        ...
        const response = await fetch
            .post(`${this.url}/queryForxCltjList`, this.params, { params: { ...this.params } });
...
export default new DayjgzcltjStore('/api/eps/control/main/basetj');
