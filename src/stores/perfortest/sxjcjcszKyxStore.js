...
class sxjcjcszKyxStore {
 ...
 @observable kyxdata = [{ value: 'ky01', label: '检测包含头文件' },{ value: 'sxjcwjHjserver', label: '文件软硬件环境server'}, { value: 'sxjcwjHjprogram', label: '文件软硬件环境program'},{ value: 'sxjcwjHjsystem', label: '文件软硬件环境system'},{ value: 'GD-3-1', label: '信息包中元数据的可读性'},{ value: 'GD-3-2', label: '目标数据库中元数据可访问性'},{ value: 'GD-3-8', label: '信息包中包含的内容数据格式合规范性'}];
 @observable zsxflData = [{ value: '电子文件元数据可用性', label: '电子文件元数据可用性' }, { value: '电子文件内容可用性', label: '电子文件内容可用性' }, { value: '电子文件软硬件环境可用性', label: '电子文件软硬件环境可用性' }, { value: '归档信息包可用性', label: '归档信息包可用性' }];
 @observable colums = [{
...
export default new sxjcjcszKyxStore();
