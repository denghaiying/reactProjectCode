...
const dabyurl =
  '/api/eps/portalui/portalui/queryForChanelName?page=1&start=0&limit=5&bh=byfb&channeltypelx=rightcontent';
const xzzxurl =
  '/api/eps/portalui/portalui/queryForChanelName?page=1&start=0&limit=6&bh=flgf&channeltypelx=rightcontent';
const zpkurl =
  '/api/eps/portalui/portalui/queryForChanelName?page=1&start=0&limit=6&bh=tpda&channeltypelx=rightcontent';

const tzgglisturl =
  '/api/eps/portalui/portalui/queryForChanelNameList?bh=tzgg&channeltypelx=rightcontent';
const dabylisturl =
  '/api/eps/portalui/portalui/queryForChanelNameList?bh=byfb&channeltypelx=rightcontent';
const xzzxlisturl =
  '/api/eps/portalui/portalui/queryForChanelNameList?bh=flgf&channeltypelx=rightcontent';
...
class RgjhomeStore extends BaseStore {
  ...
  @action datjcount = async () => {
    const url = datjsurl;
    // debugger;
    // console.log("util.getLStorage('currentCmp')",util.getLStorage('currentCmp'));
    // console.log("qhdwid",this.qhdwid);
    // console.log("SysStore.getCurrentCmp().id",SysStore.getCurrentCmp().id);
