...
class ApplyEditButtonService extends BaseService {
  findAll(params) {
  ...
  updateAllDetail(data) {
    debugger
    console.log("updateAllDetaildata", data);
    return new Promise((resolve, reject) => {
      if (!data) {
        return reject('请检查待保存数据，不能为空')
      }
...
export default new ApplyEditButtonService('/api/eps/control/main/kfjdlog');
