...
const SelectJgyjDailog = observer((props) => {
  const {
    params,
    callback,
    closeModal,
  ...
  return (
    <div className="dagl023-file-list-dialog">
      <div className="body">
        <div className='dygbt'>
          <p>{`选择或新建${spName}申请单`}</p>
        </div>
        <div className='dbbox'>
          <div className='dbboxer'>
            <h5 style={{ float: 'left', }}>选择已有的申请单：</h5>
            {/* <br /> */}
            <div className='dyhxgbox'>
              <Radio.Group
                itemDirection="ver"
              ...
              >
                  ...
                  {SelectDialStore.list &&
                    SelectDialStore.list.map((item) => (
                      <li key={`li-${item.id}`} className="item">
                        <Radio value={item.id} style={{ marginLeft: 30 }}>
                ...
                <div className="check-input">
                  <Radio value="new" style={{ marginLeft: 2 }}>
                    <Input
                      style={{ width: 771, marginLeft: 10, float: 'right' }}
                      maxLength={100}
                      placeholder="新增申请单"
        ...
        <div className='degbox'>
          <div className='degboxzj'>
            {/* <p className="desc"></p> */}
            <h5 style={{ float: 'left' }} >{`${spName}`}说明：  </h5>
            <Input.TextArea className='deginp'
              style={{ fontSize: 14, padding: 8, marginBottom: 5 }}
        ...
        <div className='sanbtn'>
          <div className='sanbtnzj'>
            <div className="btns">
              {SelectDialStore.saveParams.id == 'new' && (
                <Button
                  type="primary"
...
export default SelectJgyjDailog;
