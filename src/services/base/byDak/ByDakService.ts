...
class DakService extends BaseService implements IEpsService, ITreeService, ITableService {
    ...
    deleteDak(data) {
        return new Promise((resolve, reject) => {
            return super.post({ url: this.url + '/delete', params: data }).then(res => {
                if (res.data && res.data.success) {
                    return resolve(res.data);
                }
                return reject(res.data.message)
...
export default new DakService('/api/eps/control/main/bydak');
