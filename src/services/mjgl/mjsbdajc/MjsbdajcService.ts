...
class MjsbdajcService extends BaseService implements IEpsService, ITreeService, ITableService {
...
export default new MjsbdajcService('/api/eps/control/main/mjsbdajc');
