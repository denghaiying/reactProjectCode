...
class FulltextMenuService extends BaseService implements IEpsService, ITreeService, ITableService {
...
export default new FulltextMenuService('/api/eps/control/main/fulltextmenu/');
