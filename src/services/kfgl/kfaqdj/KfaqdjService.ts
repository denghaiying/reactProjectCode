...
class KfaqdjService extends BaseService implements IEpsService, ITreeService, ITableService {
  ...
  saveByKey(key:'', data: any) {
    data.jcrq = moment(data.jcrqValue).format('YYYY-MM-DD HH:mm:ss');
...
export default new KfaqdjService('/api/eps/control/main/kfaqdj');
