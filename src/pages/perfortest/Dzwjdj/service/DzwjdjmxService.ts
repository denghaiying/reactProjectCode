...
class DzwjdjmxService extends BaseService implements IEpsService, ITableService {
  ...
  saveByKey(key, data) {
      ...
      if (moment(data.dzwjdjxcsj)) {
        data.dzwjdjxcsj = data.dzwjdjxcsj.format("YYYY-MM-DD HH:mm:ss");
      }
...
export default new DzwjdjmxService('/api/api/dzwjdjMx');