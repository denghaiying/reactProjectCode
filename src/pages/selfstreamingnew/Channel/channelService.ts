...
class ChannelService extends BaseService implements IEpsService, ITableService {
  ...
  saveByKey(key, data) {
    return new Promise((resolve, reject) => {
      ...
      data['channelwhr'] = SysStore.getCurrentUser().yhmc;
      data['channelwhrid'] = SysStore.getCurrentUser().id;
      data['channelwhrid'] = SysStore.getCurrentUser().id;
...
export default new ChannelService('/api/streamingapi/channel');
