...
const ArchiveInfo = observer((props) => {
  ...
  //   };
  //   runFunc(funcItem);
  //   UserMenuStore.setCurrentNavList(info);
  ...
  //     //     util.setSStorage("dwname",this.dwitem.label);
  //     //   }
  //     // }
  ...
  //    }
      ...
      util.setSStorage("arch_param",info.node)
      window.top.Eps.top().runFunc("DAJD002", {
                  // dw: this.dwid,
                  // dakids: this.dakids,
                  searchValue: '1',
                  searchType:'*'
  ...
  return (
    <div className="archive-manage">
      <div className="top-section">
        ...
        <Input
          innerBefore={
            <Icon type="search" style={{ marginLeft: 6, color: "#999" }} />
          }
          addonTextAfter="检索"
          size="medium"
          style={{ width: 400 }}
          ...
          <div>
            <Table.StickyLock
              ...
              emptyContent={
                <div>
                  <img
                    src={require("../../../styles/assets/img/table-empty.png")}
                    style={{ width: 360 }}
                  />
                  <p>暂无数据</p>
                </div>
