...
import { Input, Icon, Table, Pagination, Search, Button, Dropdown, Menu, Message, Tab } from '@alifd/next'
  ...
  return (
    <div className={showMenus ? 'office-child show-menus' : 'office-child'}>
        <div className="condition">
          <Search placeholder="请输入搜索内容" onSearch={props.showAdvance} searchText={<span style={{borderTopLeftRadius: 0, borderBottomLeftRadius: 0, lineHeight: 2}}>搜索</span>} style={{ width: 300, marginRight: 10 }} />
          <Button type="primary" style={{marginRight: 10}}>
            <img className="pre_icon" src={require('../../../../styles/assets/img/file-transfer/icon_print.png')} alt=""/>打印
          </Button>
          {/* <Button type="primary" style={{marginRight: 10}}>
