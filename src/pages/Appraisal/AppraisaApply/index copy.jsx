...
const YjspStore = new AppraisaApplyStore('/eps/control/main/kfjdsp', true, true);
const YjspmxStore = new AppraisaApplyDetailStore('/eps/control/main/kfjdsp', true, true);
            ...
            <div>
              ...
              >
                ...
                {spkj && <Table.Column
                  ...
                  cell={
                    (value, index, record) => <Space size={8}>
                      <span>开放<span style={{ color: "#f50" }}>({record.kfs})</span></span>
                      <span>不开放<span style={{ color: "#2db7f5" }}>({record.bkfs})</span></span>
                    </Space>
                ...
                <Table.Column
                  ...
                  width="100px"
                  cell={
                    (value, index, record) => <span>{record.spjg == 'Y' ? "通过" :record.spjg == 'N'?'不通过':'' }</span>
                  }
                />
