...
import YsjsxService from '@/services/base/ysjsx/YsjsxService';
...
const customForm = () => {
  ...
  return (
    <>
      ...
      <Form.Item label="属性编号:" name="bh" required rules={[{ required: true, message: '请输入编号' }, { max: 10, message: '编号长度不能大于10个字符', }]}>
        <Input allowClear style={{ width: 300 }} />
      </Form.Item>
      <Form.Item label="属性名称:" name="mc" required rules={[{ required: true, message: '请输入名称' }]}>
        <Input allowClear style={{ width: 300 }} />
      </Form.Item>
...
function ysjsx() {
  ...
  return (
    <EpsPanel
      ...
      tableService={YsjsxService}                 // 右侧表格实现类，必填
      formWidth={500}
