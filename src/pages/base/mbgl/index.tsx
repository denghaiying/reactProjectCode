...
const Mbgl = observer((props) => {
  ...
  const mbglStore = useLocalObservable(() => ({
    ...
    menuProp: [
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbzlx/mbzlxgl?${qs.stringify(filter)}`,
            params: filter,
            title: '模板著录项',
            filter,
            width: 1300,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/dywmbzlx/mbzlxgl?${qs.stringify(
              filter,
            )}`,
            params: filter,
            title: '多业务模板著录项',
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mb/gdfzgl?${qs.stringify(filter)}`,
            params: filter,
            title: '固定分组',
            filter,
            width: 1000,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbgz/dhgzsz?${qs.stringify(filter)}`,
            params: filter,
            title: '档号规则设置',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbfz/gdfzsz?${qs.stringify(filter)}`,
            params: filter,
            title: '归档分组设置',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbgz/hhgzsz?${qs.stringify(filter)}`,
            params: filter,
            title: '盒号规则设置',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbfz/hhfzsz?${qs.stringify(filter)}`,
            params: filter,
            title: '盒号分组设置',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbpx/pxsz?${qs.stringify(filter)}`,
            params: filter,
            title: '排序设置',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbcx/cxtj?${qs.stringify(filter)}`,
            params: filter,
            title: '查询条件',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/lcfz/lcfzgl?${qs.stringify(filter)}`,
            params: filter,
            title: '流程分组管理',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbwyx/wyxsz?${qs.stringify(filter)}`,
            params: filter,
            title: '唯一性设置',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mb/bb?${qs.stringify(filter)}`,
            params: filter,
            title: '报表设置',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/sxjcsz/sxjcsz?${qs.stringify(filter)}`,
            params: filter,
            title: '页数转页次',
            filter,
            width: 1200,
      ...
      },
      {
        ...
        onClick: (ids, store, records) => {
          ...
          mbglStore.doArchAction(records, {
            url: `/api/eps/control/main/mbgsjs/gsjs?${qs.stringify(filter)}`,
            params: filter,
            title: '公式计算',
            filter,
            width: 1200,
    ...
    async queryLbList() {
      // if (!this.dwData || this.dwData.length === 0) {
      const response = await fetch.get(
        `/api/eps/control/main/sjzdmx/queryForList?fid=SJZD020`,
      );
      if (response.status === 200) {
        var sjData = [];
        if (response.data.length > 0) {
    ...
    async queryDywstflList() {
      // if (!this.dwData || this.dwData.length === 0) {
      const response = await fetch.get(
        `/api/eps/control/main/stflwh/queryForList`,
      );
      if (response.status === 200) {
        var sjData = [];
        if (response.data.length > 0) {
      ...
      <>
        ...
        <Form.Item label="类型:" name="lx" required>
          <Select style={{ width: 300 }} placeholder="请选择">
            {LxList &&
              LxList.map((item) => (
                <Option key={item.value} title={item.item}>
                  {item.item}
                </Option>
              ))}
          </Select>
        ...
        <Form.Item label="业务分组:" name="dywstfl">
          ...
          >
            {mbglStore.dywstflData &&
              mbglStore.dywstflData.map((item) => (
                <Option key={item.value} title={item.mc}>
                  {item.mc}
                </Option>
              ))}
          </Select>
            ...
            beforeOpen={(value) => {
              ...
              if (rowJn != null) {
                window.location.href =
                  '/api/eps/control/main/mbsz/exportFile?id=' +
                  record.id +
                  '&mc=' +
                  record.mc +
                  '&jnId=' +
  ...
  return (
    <>
      ...
      ></DwTableLayout>
      <ArchMenuAction
        params={mbglStore.archParams}
        modalVisit={mbglStore.modalVisit}
        archStore={mbglStore}
