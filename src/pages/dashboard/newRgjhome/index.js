    ...
    <div className="home-page">
      ...
      <div className="center">
        <div className="part part4">
          <div className="head">
            ...
            <span className="right-link" onClick={opencgll}>
              馆藏浏览
            </span>
          </div>
          <div className="inner-row">
            <div className="row" style={{ marginBottom: 50, marginTop: 30 }}>
              <Input
                prefix={
                  <SearchOutlined
                    style={{ margin: '4px 10px', fontSize: 16, color: '#999' }}
                  />
                }
                placeholder="请输入搜索内容"
                style={{ width: '82%' }}
        ...
        <div className="part part5">
          <div className="head">
            <span className="head-left">
            <img src={todo} className="icon-label" alt="" style={{marginRight: 10}}/><span>待办事项</span>
            </span>
        ...
        <div className="part part6">
          <div className="head">
            <span className="head-left">
              ...
              <img src={photo} className="icon-label" alt="" style={{marginRight: 10}}/><span>档案动态</span>
            </span>
            <span className="right-link" onClick={() => openym('tpda')}>
              {'<更多>'}
            </span>
          </div>
                  ...
                  <li className="slide" key={item.contentId}>
                    <div className="item">
                      {item.docs[0] !== undefined ? (
                        <div className="inner" onClick={() => getChannelIdByName('tpda', item.content.id) } >
                          <img src={'data:image/png;base64,' + item.docs[0].thumb} />
                        </div>
                      ) : (
                        <div className="inner" onClick={() => getChannelIdByName('tpda', item.content.id) } >
                          <img src={import( '../../../styles/assets/img/icon_photo.png')} />
                        </div>
                      )}
      ...
      <div className="right">
        <div className="part part2">
          <div className="head">
            <span className="head-left">
            <img src={downCenter} className="icon-label" alt="" style={{marginRight: 10}}/><span>下载中心</span>
            </span>
        ...
        <div className="part part9">
          <div className="head">
            <span className="head-left">
              <img src={viewNum} className="icon-label" alt="" style={{marginRight: 10}}/><span>访问量</span>
            </span>
          </div>
