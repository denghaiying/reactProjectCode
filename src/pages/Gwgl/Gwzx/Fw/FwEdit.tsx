...
const FwEdit = observer((props) => {
  ...
  return (
    <div className="fabox">
      ...
      {/* 左边输入信息 */}
      <div className="faleft" id="faleftid">
            ...
            <div className="faa-bt">
              ...
              <div className="fa-yyicx">
                <Form
                  ...
                  autoComplete="off"
                >
                  <Form.Item className="fa-f" label="紧急程度" name="username">
                    {/* 单选按钮 */}
                    <Radio.Group
                      name="radiogroup"
                      defaultValue={1}
              ...
              <div className="fa-yyer">
                ...
                >
                  <Form.Item className="fa-fcxb" label="拟稿人">
                    ...
                    <Modal
                      getContainer={document.getElementById('faleftid')}
                      title="请输入拟稿人："
                      style={{ top: 300 }}
                ...
                {/* <Form
                                    ...
                                    >
                                        <Form.Item className='fa-fcxb'
                                            label="文种"
                                        >
                                            <Button className='fa-inpcxb' onClick={() => setModal1Visibleaawz(true)}>
                                                <span className='anniuzia'>点击输入</span>
                                                </Button>
                                                    <Modal
                                                    title="请输入文种："
              ...
              <div className="fa-yyi">
                ...
                >
                  <Form.Item className="fa-fcxb" label="分发" name="username">
                    {/* <Button className='fa-inpcxb' >点击输入</Button> */}
                    {/* <Button className='fa-inpcxb' onClick={() => setModal1Visible(true)}>
                                                <span className='anniuzia'>点击输入</span>
                                            </Button>
                                            <Modal
                                                title="分发"
