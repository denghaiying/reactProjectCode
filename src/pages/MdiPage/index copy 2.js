...
// const EIFrame = props => {
//   const { intl: { formatMessage }, match: { params: { umid } } } = props;
...
//   return (
//     <div>
//       <iframe ref={ref} style={{ width: '100%', height: "calc(100vh - 55px)", overflow: 'visible' }} src={decodeURIComponent(`/api/eps/control/main/iframePage?rungn=${umid}`)} scrolling="no"
//         frameBorder="0" />
//       <div ref={divRef}>
//         {comp}
//       </div>
