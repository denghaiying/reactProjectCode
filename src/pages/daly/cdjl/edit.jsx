...
const LydjEdit = observer(() => {
  ...
  useEffect(() => {
    ...
    LydjStore.editRecord.yysj = LydjStore.editRecord.yysj ? moment(LydjStore.editRecord.yysj).format('YYYY-MM-DD HH:mm:ss') : undefined
          ...
          <Row>
            ...
            <Col>
              <FormItem fullWidth label="预约时间：" {...formItemLayout}>
                <DatePicker name="yysj" disabled={opt === 'view'} showTime />
              </FormItem>
            </Col>
      ...
      <Row gutter={4} className="dakresult">
        <Col span={24}>
          <Tab size="small">
            ...
            <Tab.Item key="epsSerach" title="全文检索" style={{ height: '100%', }}>
              <div
                id="scrollableDiv"
                style={{
                  //height: '400px',
  ...
  return (
    <div className="hall-regist" style={{ paddingTop: '10px' }} ref={ref}>
      <div className="editform">
        <Steps current={step} size="small" style={{ marginLeft: '10%', width: '80%' }}>
          {steps.map((s, index) => (
