...
class CqbcwjzhlogService extends BaseService implements IEpsService, ITableService {
...
export default new CqbcwjzhlogService('/api/eps/control/main/cqbcwjzhlog');
