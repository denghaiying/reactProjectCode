      ...
      <div className="login-page">
        ...
        <div className="content">
          <div className="left">
            ...
            <img src={leftBgPng} className="left-bg" alt="" />
            <img src={lightPng} className="light lightmove" alt="" />
            {/* <p className="bottom-text"><span style={{ marginRight: '15px' }}>智慧城市</span><span>万物互联</span></p> */}
          </div>
          <div className="right">
            ...
            <p className="form-title">
              {formatMessage({ id: 'e9.login.title' })}
            </p>
            {!LoginStore.isScan && (
              <form className="login-form">
                <li className="item">
                  <span className="icon-span">
                    <img src={accountPng} className="icon-label" alt="" />
                  </span>
                  <input
                    type="text"
                    className="my-input"
                ...
                <li className="item">
                  <span className="icon-span">
                    <img src={passwordPng} className="icon-label" alt="" />
                  </span>
                  <input
                    type="password"
                    className="my-input"
                ...
                {LoginStore.vscodebloon && (
                  <div className="verify-div">
                    <li className="item" style={{ marginBottom: '16px' }}>
                      <span
                        className="icon-span"
                        style={{ verticalAlign: 'baseline', color: '#999999' }}
                      >
                        T
                      </span>
                      <input
                    ...
                    <div className="verifyContainer">
                      <GVerify
                        id={gvid}
                        getIdentifyValue={getIdentifyValue}
                        className="verifyCanvas"
                      />
                    </div>
                  </div>
                )}
            ...
            {LoginStore.isScan && (
              <img src={qrCodePng} alt="" className="code-img" />
            )}
          </div>
        </div>
