...
const Yh = observer((props) => {
        ...
        render: (text, record) => (
          <Space size="middle">
            <a href="javascript:;" onClick={() => onEditAction(record)}>
              <Tooltip title="修改">
                <img
                  src={require('../../../styles/assets/img/hall-regist/icon_dengji.png')}
                  style={{ width: 20 }}
                />
              </Tooltip>
            </a>
            <a href="javascript:;" onClick={() => onCopyAction(record)}>
              <Tooltip title="复制">
                <img
                  src={require('../../../styles/assets/img/hall-regist/icon_dengji.png')}
                  style={{ width: 20 }}
            ...
            <a href="javascript:;" onClick={() => onLookAction(record)}>
              <Tooltip title="查看">
                <img
                  src={require('../../../styles/assets/img/hall-regist/icon_dengji.png')}
                  style={{ width: 20 }}
            ...
            <a href="javascript:;" onClick={() => onRoleAction(record)}>
              <Tooltip title="角色">
                <img
                  src={require('../../../styles/assets/img/hall-regist/icon_dengji.png')}
                  style={{ width: 20 }}
            ...
            <a href="javascript:;" onClick={() => onUpdatPwdAction(record)}>
              <Tooltip title="修改密码">
                <img
                  src={require('../../../styles/assets/img/hall-regist/icon_dengji.png')}
                  style={{ width: 20 }}
  ...
  const onAddAction = () => {
    ...
    const json = {
      dwmc: dmc,
      whrid: SysStore.currentUser.id,
      whr: SysStore.currentUser.yhmc,
      whsj: moment(),
    };
      ...
      <div className="banner">
        ...
        <div>
          ...
          <Button type="primary" style={{ marginRight: 10 }}>
            ...
            <FormattedMessage id="e9.btn.preview" />
          </Button>
