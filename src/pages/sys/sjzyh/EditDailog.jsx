      ...
      >
        <FormItem label="单位" labelWidth={205} required>
          ...
          <Select
            tagInline
            name="dwid"
            defaultValue={Store.dwid.id}
            placeholder="单位"
            hasClear
            disabled={Store.dwstatus}
            dataSource={Store.dwDataSource}
            style={{ width: 200 }}
          />
        </FormItem>

        <FormItem required label="登录号" labelWidth={205}>
          <Input name="bh" placeholder="登录号" style={{ width: 200 }} />
        </FormItem>
        <FormItem required label="用户名" labelWidth={205}>
          <Input name="yhmc" placeholder="用户名称" style={{ width: 200 }} />
        </FormItem>

        <FormItem label="性别" labelWidth={205}>
          <Select name="xb" style={{ width: 200 }}>
            <option value="1">男</option>
            <option value="2">女</option>
          </Select>
        </FormItem>
        <FormItem label="任职部门" required labelWidth={205}>
          ...
          <Select
            ...
            placeholder="任职部门"
            hasClear
            dataSource={Store.orgDataSource}
            style={{ width: 200 }}
          />
        </FormItem>
