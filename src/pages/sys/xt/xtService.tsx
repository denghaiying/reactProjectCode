...
class XtService extends BaseService implements IEpsStore,ITreeService,ITableService {
  ...
  findByKey(key: string | number, page: number = 1, size: number = 20, args: object = {}): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
        return super.get({url: this.url + '/queryForId' ,params: args}).then(res => {
          if(res.status > 300){
            return reject(res)
          }
...
export default new XtService('/api/eps/control/main/xt');
