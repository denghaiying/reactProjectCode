...
class CddshService extends BaseService implements ITableService {
  //分页查询
  ...
  findAll(params) {
    debugger
    return super.get({
      url: `${this.url}/dsh/${SysStore.getCurrentCmp().id}`,
      params: params
    })
  }
  // 新增数据
...
export default new CddshService('/api/eps/e9msdaly/lasqd');
