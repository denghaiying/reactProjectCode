...
//   };
//   render() {
//     const columns = [{title: '附件', dataIndex: '', key: 'x', align: 'center',  render: () => <img src={require('../../../assets/img/file-transfer/icon_accessory.png')} alt="" style={{width: 22}}/>},
...
//                       {title: '操作', dataIndex: '', align: 'center', render: (text, record) => <div><img src={require('../../../assets/img/file-transfer/icon_edit.png')} alt="" style={{width: 22}}/>
//                         <img src={require('../../../assets/img/file-transfer/icon_book.png')} alt="" style={{width: 22, margin: '0 7px'}}/>
//                         <img src={require('../../../assets/img/file-transfer/icon_view2.png')} alt="" style={{width: 22}}/></div>
//     }];
//     const rowSelection = {
...
//           <div className="left">
//             <span className="banner-title"><img src={require('../../../assets/img/icon_rili.png')} alt=""/><span>我的日程</span></span>
//           </div>
//           <div>
...
//                 {
//                   !this.state.searchResult.length ? <div className="empty"><img src={require('../../../assets/img/icon_empty.png')}/><p>暂无数据</p></div> : <div>
//                     <p className="label-p">直接参与的工作</p>
//                     <li className="item">
//                       <Checkbox onChange={() => {}} /> 
//                       <span className="item-text">蔡3月20号之前的研发工作</span>
//                       <img src={require('../../../assets/img/icon_star.png')} style={{width: 25}}/>
//                     </li>
//                   </div>
//                 }
//               </div>
