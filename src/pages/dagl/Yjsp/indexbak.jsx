    ...
    <div className="file-transfer">
      <div className="file-content">
        <div className="top">
          <div className="condition">
            <div className="right" style={{ paddingLeft: 150 }}>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <Button  type="primary" onClick={openUpload}><Icon type="upload"/>上传</Button>
             {/* &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <Button  type="primary" onClick={openPrint}><Icon type="upload"/>打印</Button>*/}
              <WflwButtons
          ...
          >
            ...
            <Table.Column cell={renderTableCell} width="150px" lock="right" />
          </Table>
          <Pagination
            //   className="footer"
            //   className="footer"
        ...
        <div className="bottom">
          ...
          {tabkey == "1" &&
            <div>
              ...
              >
                ...
                <Table.Column dataIndex="remark" alignHeader="center" title="移交说明" width="200px" />
          ...
          {tabkey == "2" &&
            <Datable
              params={{ dakid: DapubStore.childlist[YjspmxStore.params.dakid], tmzt: "1" }}
              fileCol
