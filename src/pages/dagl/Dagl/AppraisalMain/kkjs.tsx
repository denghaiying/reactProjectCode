...
const kkjs = (props) => {
  ...
  const csstore = useLocalObservable(() => ({
    expandAll: false,
    async initexpandAll() {
      const res = await fetch.get(
        `/api/eps/control/main/params/queryParamsValueById?pcode=DAGLS003`,
      );
      debugger;
      if (res.data.value === 'Y') {
        this.expandAll = true;
        ...
        <div className="oa-manage">
          ...
          <div className={'content'}>
            <div className="tree">
              <DakTree
                onSelect={onSelect}
                defaultExpandAll={csstore.expandAll}
                store={Store}
