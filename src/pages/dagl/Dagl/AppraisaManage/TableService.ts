...
class TableService extends BaseService implements IEpsService, ITableService {
  ...
  findByKey(
    ...
    // inited 判断初始化完毕
    if (!args.bmc || !args.inited) {
      return;
    }
    // gcid 如果存在gcid，则把gcid给fid
    if (args.gcid) {
      args.fid = args.gcid;
    }
    const bmc = args.bmc;
    ...
    for (const i in args) {
      if (i != 'key' && args[i]) {
        ...
        if (i.toUpperCase() === i) {
          ...
          con.push(
            `{"nm":"${i}",vl:${args[i]},"exAttr01":"07","exAttr02":"${i}","exAttr03":"C"}`,
          );
        }
      }
    }
    ...
    if (args && args.params && args.params.initQuery) {
      args.initQuery = JSON.stringify(args.params.initQuery);
    }
    // if (key === 'root') {
    //   psql = '((1=1))';
    // }
    ...
    return new Promise((resolve, reject) => {
      return super
        .post({ url: this.url + '/queryForPage?' + qs.stringify(args) })
        .then((res) => {
          if (res.status > 300) {
  ...
  getKTable(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: this.url + '/queryKTable', params })
        .then((res) => {
  ...
  getKField(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: this.url + '/queryKFields', params })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  getSjqxSql(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/sjqxvalue/getSjqxSql', params })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  getSearchColumns(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/mbcx/queryForList', params })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  getGuid() {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/wdgl/attachdoc/getGuid' })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  getDoctype() {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/wdgl/doctype/queryForList' })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  getFjmjlist() {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/sjzdmx/queryForList?fid=SJZD019' })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  fjmjSfqy() {
    ...
    const params = { code: 'WDS011', gnid: '', yhid: yh.id };
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/params/getUserOption', params })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
          return resolve(res.data.message == 'Y' ? true : false);
        })
        .catch((err) => {
          return reject(err);
        });
  ...
  cqbcDataRecovery(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/dacqbc/cqbcDataRecovery', params })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  newcqbcDataRecovery(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({
          url: '/api/eps/control/main/dacqbc/newcqbcDataRecovery',
          params,
        })
        .then((res) => {
          if (res.status > 300) {
  ...
  searcGjc(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/jdgjcwh/queryForList', params })
        .then((res) => {
          debugger;
          if (res.status > 300) {
            return reject(res);
