...
const lxTypeData =[{value: '0', label: '长期保存'},{value: '1', label: '其他'},{value: '2', label: '长期保存转存'}];
  ...
  return (
    <>
      ...
      <Form.Item label="类型:" name="lx" required rules={[{ required: true, message: '请选择类型' }]}>
          <Select   placeholder="请选择类"  options={lxTypeData} style={{width:  _width}}/>
      </Form.Item>
      <Form.Item name="zt" label="状态:" initialValue="false">
          <Radio.Group>
            <Radio.Button value="true">开启</Radio.Button>
            <Radio.Button value="false">关闭</Radio.Button>
          </Radio.Group>
      </Form.Item>
      <Form.Item name="blyw" label="保留原文:" initialValue="false">
          <Radio.Group>
