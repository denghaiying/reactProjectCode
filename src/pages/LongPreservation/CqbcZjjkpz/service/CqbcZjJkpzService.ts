...
class CqbcZjJkpzService extends BaseService implements IEpsService, ITableService {
  ...
  saveByKey(key, data) {
    ...
    return new Promise((resolve, reject) => {
      ...
      data['dwid'] = SysStore.getCurrentCmp().id;
...
export default new CqbcZjJkpzService('/api/eps/lg/zjkjkpz');
