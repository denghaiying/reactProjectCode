...
class CqbcZjZdgxService extends BaseService implements IEpsService, ITableService {
  ...
  saveSj(val) {
    ...
    return new Promise((resolve, reject) => {
      ...
      return super.post({ url: this.url+"/insertSome", data: data}).then(res => {
...
export default new CqbcZjZdgxService('/api/eps/lg/zjzdgx');
