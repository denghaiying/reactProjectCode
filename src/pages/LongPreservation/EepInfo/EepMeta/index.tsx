...
import eepMetaService from './service/EepMetaService';
...
const customAction = (store: EpsTableStore, ids: any[]) => {
  ...
  // 创建右侧表格Store实例
  const [tableStore] = useState<EpsTableStore>(new EpsTableStore(eepMetaService));
  ...
  return (
    <>
      <EpsPanel title={title}                    // 组件标题，必填
        ...
        tableService={eepMetaService}             // 右侧表格实现类，必填
        ref={ref}                                // 获取组件实例，选填
        formWidth={500}
