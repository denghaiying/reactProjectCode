...
import Kfco2Service from '@/services/mjgl/kfco2/Kfco2Service';
...
function kfco2() {
  ...
  const searchFrom = () => {
    return (
      <>
        ...
        <FormItem label="CO2:" name="co2" ><Input  placeholder="请输入co2数值" style={{ width: 300 }}/></FormItem>
  ...
  return (
    <EpsPanel
      ...
      tableService={Kfco2Service}                 // 右侧表格实现类，必填
      formWidth={500}
