...
import Kfpm25Service from '@/services/mjgl/kfpm25/Kfpm25Service';
...
function kfpm25() {
  ...
  const searchFrom = () => {
    return (
      <>
        ...
        <FormItem label="PM25:" name="pm25" ><Input  placeholder="请输入PM25数值" style={{ width: 300 }}/></FormItem>
  ...
  return (
    <EpsPanel
      ...
      tableService={Kfpm25Service}                 // 右侧表格实现类，必填
      formWidth={500}
