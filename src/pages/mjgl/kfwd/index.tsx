...
import KfwdService from '@/services/mjgl/kfwd/KfwdService';
...
function kfwd() {
  ...
  const searchFrom = () => {
    return (
      <>
        ...
        <FormItem label="温度:" name="wd" ><Input  placeholder="请输入温度" style={{ width: 300 }}/></FormItem>
  ...
  return (
    <EpsPanel
      ...
      tableService={KfwdService}                 // 右侧表格实现类，必填
      formWidth={500}
