...
import archiveInfoService from './service/ArchiveInfoService';
...
const customForm = () => {
  ...
  return (
    <>
      ...
      <Form.Item label="业务号:" name="archiveinfoCode" required rules={[{ required: true, message: '请输入业务号' }]}>
        <Input allowClear style={{ width: 300 }} />
      </Form.Item>
        <Form.Item label="业务名称:" name="archiveinfoName" required rules={[{ required: true, message: '请输入业务名称' }]}>
        <Input allowClear style={{ width: 300 }} />
      </Form.Item>
        <Form.Item label="ftp路径:" name="archiveinfoPath" required rules={[{ required: true, message: '请输入ftp路径' }]}>
        <Input allowClear style={{ width: 300 }} />
      </Form.Item>
        <Form.Item label="启用:" name="archiveinfoUsing">
           <Switch name="archiveinfoUsing" defaultChecked={true} />
      </Form.Item>
      <Form.Item label="类型:" name="archiveinfoType"  required rules={[{ required: true, message: '请选择类型' }]}>
         <Radio.Group name="archiveinfoType" >
