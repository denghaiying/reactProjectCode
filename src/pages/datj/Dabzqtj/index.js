...
import Store from "../../../stores/datj/Dabzqtj";
    ...
    const downloadFileToExcel = (() => {
     ...
     dataTable=Store.columnResult;
         ...
         dataTable.push(tobj);  //设置excel中总计的数据源
          ...
          option.fileName = '保管期统计';  //excel文件名称
          option.datas = [
                {
                  sheetData: dataTable,  //excel文件中的数据源
                  sheetName: '保管期统计',  //excel文件中sheet页名称
            ...
            <div className="search-content">
                ...
                <div className="cell">
                    ...
                    <TreeSelect {...field.init('dakid', {})}  placeholder={formatMessage({ id: 'e9.datj.select' })}
                                ...
                                dataSource={SearchStore.dakDataSource}   className="input"/>
                </div>
                ...
                <div className="cell" >
                    <span className="label">档案库状态</span>
                      <Select   name="tmzt"  tagInline className="input" placeholder={formatMessage({ id: 'e9.datj.select' })}
                                mode="multiple"  onChange={handleTmzt} >
