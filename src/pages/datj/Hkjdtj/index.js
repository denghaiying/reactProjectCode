...
import Store from "../../../stores/datj/HkjdtjStore";
        ...
        <div className="statistic-page">
            <div className="search-content">
                <div className="cell">
                    ...
                    <Select className="input" name="dws" mode="multiple"
                ...
                <div className="cell" >
                    ...
                    <RangePicker onChange={handleDate} onOk={onDateOK} className="input" placeholder={["开始日期", "结束日期"]}></RangePicker>
                </div>

                <div className="cell" >
                    <span className="label">档案年度:</span>
                    <Input name="nd" className="input" placeholder="请输入档案年度" onChange={handleNd} />
                </div>

                <div className="cell">
                    <span className="label">保管期限:</span>
                    <Select className="input" name="bgqx"
                        placeholder={formatMessage({ id: 'e9.datj.select' })}
                ...
                <div className="cell" className={isExpand ? "cell" : 'cell hidden'}>
                    ...
                    <Input name="tm" className="input" placeholder="请输入题名" onChange={handleTm} />
                </div>
