  ...
  const formatMessage=intl.formatMessage;
    ...
    const doSearchAction = (() => {
        ...
        if(rq) {
            ...
            if ((ks == "" && js != "") || (ks != "" && js == "")) {
                openNotification('登记时间需输入起止时间！', 'warning');
                df = false;

            }
            if (Date.parse(ks) - Date.parse(js) > 0) {
                openNotification('起始时间要在结束时间之前!', 'warning');
                df = false;
            }
        }
        let values= {};
    ...
    const downloadFileToExcel = (() => {
       ...
       dataTable=Store.columnResult;
           ...
           dataTable.push(tobj);  //设置excel中总计的数据源
            ...
            option.fileName = '利用登记大厅统计';  //excel文件名称
            option.datas = [
                  {
                    sheetData: dataTable,  //excel文件中的数据源
                    sheetName: '利用登记大厅统计',  //excel文件中sheet页名称
            ...
            <div className="statistic-page">
                <div className="search-content">
                    ...
                    <div className="cell">
                        ...
                        <TreeSelect {...field.init('dakid', {})}
                                    placeholder={formatMessage({ id: 'e9.datj.select' })}
                                    hasClear name="dakid"
                                    treeCheckable onChange={handleDakid}
                                    value={Store.dakid}
                    ...
                    <div className="cell" >
                        ...
                        <Select  className="input" name="daklx" mode="multiple"  tagInline
                                 placeholder={formatMessage({ id: 'e9.datj.select' })}
                    ...
                    <div className="cell" >
                        ...
                        <Select tagInline onChange={handleTmzt}  name="tmzt" className="input" placeholder={formatMessage({ id: 'e9.datj.select' })}  mode="multiple">
                    ...
                    <div className="cell" className={isExpand ? "cell" : 'cell hidden'}>
                        ...
                        <Input name="djr" className="input" onChange={handleDjr}
                    ...
                    <div className="cell" className={isExpand ? "cell" : 'cell hidden'}>
                        ...
                        <Select tagInline onChange={handleXslx}  className="input" defaultValue="tjlb"
                                name="xslx" placeholder={formatMessage({ id: 'e9.datj.select' })}>
                            <Option value="tjlb">统计列表</Option>
                        </Select>
                    </div>
                    <div className="cell" className={isExpand ? "cell" : 'cell hidden'}>
                        <span className="label">登记时间</span>
