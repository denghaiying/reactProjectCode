...
const EpsUpload = observer((props, refs) => {
  ...
  const enableConvertViewDoc =
      props.uploadProp?.enableConvertViewDoc === undefined
        ? false
        : !props.uploadProp?.enableConvertViewDoc;

  const enableConvertDown =
        props.uploadProp?.enableConvertDown === undefined
          ? false
          : !props.uploadProp?.enableConvertDown;
