...
class Home extends React.Component {
  ...
  cgzs() {
    window.location.href='/eps/self/selfservice/index#/house-show-pc';
  }

  zcfg(type) {
    window.location.href='/eps/self/selfservice/index#/yange-local-pc?name='+type;
  }
  xxfj() {
    window.location.href='/eps/self/selfservice/index#/file-query-pc';
  }
        ...
        <div className={`${style['body']}`}>
          <div className={`${style['common']}`}>
            ...
            <div className={`${style['right']}`}>
              ...
              <a href="javascript:;" onClick={() => this.zcfg('政策法规')}>
                ...
                <a href="javascript:;" onClick={() => this.zcfg('本地沿革')}>
