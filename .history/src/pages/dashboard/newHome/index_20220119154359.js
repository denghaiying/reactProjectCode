    ...
    <div className='newHome-body'>
        ...
        <div className='common-b'>
          ...
          <div className='content'>
              {store.dbList && store.dbList.map(item => (
                    <div key={item.wfinst} className="common-lines">
      ...
      <div className='common-line'>
        <div className='common-b'>
          ...
          <div id="pieChart" className='content' style={{ height: 300 }}></div>
        </div>
        <div className='common-b'>
          <div className='title'>
            <img src={jstj} alt=""/>
          ...
          <div id="columnChart" className='content' style={{ height: 300 }}></div>
        </div>
      </div>
    </div>
  </div>
