...
class PbuttonService extends BaseService implements IEpsService, ITableService {

  findByKey(key: string | number, page: number = 1, size: number = 10, args: object = {}): Promise<any> {
      debugger
      args["pbuttonzsmkbjid"]=key;
...
export default new PbuttonService('/api/eps/ksh/pbutton');
