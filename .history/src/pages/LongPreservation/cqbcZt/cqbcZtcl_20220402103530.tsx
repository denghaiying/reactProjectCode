...
import { message, Tooltip, Modal, Button, Table, Transfer,Space } from 'antd';
...
import { InteractionTwoTone, UpOutlined, DownOutlined } from '@ant-design/icons';
        ...
        <>
            ...
            <Modal title={<span className="m-title">策略</span>}
                ...
                <div   class="ant-modal-footer">
                    <Button className='sy' onClick={() => onButtonClick('sy')}>
                       <Space className='tb'>
                         <UpOutlined />
                       </Space>
                        &nbsp;上移 
                     ...
                     <Button className='xy' onClick={() => onButtonClick('xy')}>
                       <Space className='tb'>
                       <DownOutlined />
                       </Space>
                        &nbsp;下移 
                ...
                <div className='px'>
                     <div className='pxwz'>排序设置：</div>
                     <div className='anniu'>
                       {/* <Radio name='anaa' >升序</Radio>
                       <Radio name='ana'>降序</Radio> */}
                       <input type="radio" name="gender" value="male"  /><label>&nbsp;升序</label>
                               <input type="radio" name="gender" className='anniua' value="female" checked="checked" id="female" /><label >&nbsp;降序</label> 
                     </div>
                   </div>
