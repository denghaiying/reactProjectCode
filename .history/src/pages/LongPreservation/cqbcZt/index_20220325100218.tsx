...
const customForm = () => {
  ...
  return (
    <>
      ...
      <Form.Item label="总容量:" name="zrl" initialValue="0" required rules={[{ required: true, message: '请输入总容量' }]}>
        <InputNumber  type="inline" step={0.5}  min={0}  max={2000}   style={{ width:  _width-10 }} />G
      </Form.Item>
