...
class CqbcZjDakService extends BaseService implements IEpsService, ITreeService, ITableService {
...
export default new CqbcZjDakService('/api/eps/control/main/cqbcdak');
