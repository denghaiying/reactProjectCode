...
const EditTable = observer((props) => {
  ...
  useEffect(() => {
    const queryzjkzdList = async () => {
      const zjkzdresponse = await fetch.post("/api/eps/lg/cqbczdgx/findAllMbzlx", { bmc: props.midtbname });
    ...
    const querymbzlxList = async () => {
      const kkdyponse = await fetch.post("/api/eps/lg/cqbckkdy/findForKeyMb", { jkid: props.jkpzid });
