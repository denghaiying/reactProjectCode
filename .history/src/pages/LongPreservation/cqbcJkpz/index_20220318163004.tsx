...
const customForm = () => {
  ...
  return (
    <>
      ...
      <Form.Item label="中间库接口:" name="dydzwjjkid" required rules={[{ required: true, message: '请选择中间库接口' }]}>
         <Select   placeholder="中间库接口"   options={dzwjjkpzlist} style={{width:  _width}}/>
      </Form.Item>
  ...
  useEffect(() => {
      ...
      const queryDzwjjkpzList =  async () =>{
        let url="/api/eps/lg/zjkjkpz/findForKey";
