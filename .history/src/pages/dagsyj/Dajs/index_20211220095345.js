...
const Dajs = observer((props) => {
  const store = useLocalStore(() => ({
    ...
    async initSj() {
      ...
      const ressj = await DajsService.qureydajssj({ zt: 'D',username:SysStore.getCurrentUser().yhmc });
  ...
  const doztAction = async (e) => {
    const ressj = await DajsService.qureydajssj({ zt: e,username:SysStore.getCurrentUser().yhmc  });
