...
const Role = observer((props) => {
  ...
  const customAction = (store: EpsTableStore, ids: any[]) => {
    return ([
      <>
         <EpsModalButton name="业务权限1" title="业务权限1" width={1200}   useIframe={true}  url={'/api/eps/control/main/dakqx/ywqxszMain'}     params={{ record:ids,dwid:RoleStore.dw_id}} icon={<SettingOutlined />}/>
