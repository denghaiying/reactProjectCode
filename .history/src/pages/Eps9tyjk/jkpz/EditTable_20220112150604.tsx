...
const columns : ProColumns<DataSourceType>[]= [
  ...
  useEffect(() => {
    if (props.mblzx.length > 0) {
      let  mbData = props.mblzx.map(o => ({ 'id': o.id, 'ms':o.ms, 'mc': o.mc, 'zdlx': o.lx,'dakzd':'', 'zdmc':'', 'zdmrz':'','name':props.jkpname,'jkid':props.jkpzid,'whsj':getDate}));
      ...
      submitter={{
        ...
        render: (props, doms) => {
          ...
          return [
            ...
            <Button  type="primary" key="submit" onClick={() =>submitsj(dataSelectedRows)}>
              导入
            </Button>
          ];
        },
