  ...
  const EditStore = useLocalObservable(() => (
    {
      ...
      changezd(val) {
        ...
        runInAction(() => {
          ...
          //     }
          //   }
          //   for (var i = this.selectRowKeys.length - 1; i > -1; i--) {
          //     if (this.selectRowKeys[i] == val.id) {
          //       this.selectRowKeys.splice(i, 1);
          //     }
          //   }
          // } else {
          //   this.rowsData.push(val);
          //   this.selectRowKeys.push(val.id);
          // }
       // })
       var a=[];
       this.keysData.push(val.id);
       //this.keysData=a;
       this.selectRowKeys= ['MBZLX202110261701280008','MBZLX202111181636040022'];
      //  this.selectRowKeys=[val.id];
      })
    }
  }))
  const rowSelection = {
