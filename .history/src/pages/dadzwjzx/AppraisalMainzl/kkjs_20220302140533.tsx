...
// import Dzwjzx from '../charts/Dzwjzx';
...
const kkjs = (props) => {
  ...
  const onSelect = (selectedKeys, info) => {
    ...
    history.push({
      pathname: `/runRfunc/archManage/${others.id}/2`,
      query: params,
    });
  };
  ...
  const ontaleSelect = async (record) => {
    ...
    history.push({
      pathname: `/runRfunc/archManage/${dakid}/2`,
      query: params,
    });
  };
  ...
  const doSearchAction = (formData, tableStore) => {
    ...
    const params = { dakzt: 2, key: formData.key, dakid: Store.dakid };
      ...
      {() => (
        <div className="oa-manage">
          ...
          <div className={'content'}>
            ...
            <div className="right" style={{ width: 'calc(100% - 270px)' }}>
              {/* <Dzwjzx /> */}
            </div>
          </div>
        </div>
