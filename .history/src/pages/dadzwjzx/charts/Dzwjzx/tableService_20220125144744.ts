...
class TableService extends BaseService {
  ...
  querydzwjColumn(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/basetj/queryForDzwjzxList', params })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
  ...
  querydzwjLine(params) {
    return new Promise((resolve, reject) => {
      return super
        .post({ url: '/api/eps/control/main/basetj/queryForDzwjzxnd', params })
        .then((res) => {
          if (res.status > 300) {
            return reject(res);
          }
