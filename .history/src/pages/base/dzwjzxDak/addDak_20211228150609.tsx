 ...
 */
    ...
    const addFunction = async (values) => {
        DzwjzxDakService.addDak(values).then(res => {
            ...
            <Modal title={<span className="m-title">新建档案库</span>}
                ...
                <Form labelCol={{ span: 8 }} form={form} className="schedule-form" name="shForm" initialValues={{}}>
                    <Row gutter={20}>
                        ...
                        <Col span={span}>
                            <FormItem label="新增时生成档号:" name="instdh" initialValue={false}>
                                <Switch checkedChildren="开启" unCheckedChildren="关闭" />
                            </FormItem>
                        </Col>
                        <Col span={span}>
                            <FormItem label="归入整编启用流程:" name="sjlc" initialValue={false}>
                                <Switch checkedChildren="开启" unCheckedChildren="关闭" />
                            </FormItem>
                        </Col>
                        <Col span={span}>
                            <FormItem label="档案归档启用流程:" name="gdlc" initialValue={false}>
                                <Switch checkedChildren="开启" unCheckedChildren="关闭" />
                            </FormItem>
                        </Col>
                        <Col span={span}>
                        ...
                        <Col span={span}>
                            <FormItem label="整理首页显示:" name="zlsyxs" initialValue={false}>
                                <Switch checkedChildren="开启" unCheckedChildren="关闭" />
                            </FormItem>
                        </Col>
                        <Col span={span}>
                            <FormItem label="管理首页显示:" name="glsyxs" initialValue={false}>
                                <Switch checkedChildren="开启" unCheckedChildren="关闭" />
                            </FormItem>
                        </Col>
