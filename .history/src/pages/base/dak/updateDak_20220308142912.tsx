            ...
            <Modal title={<span className="m-title">修改档案库</span>}
                ...
                <Form labelCol={{ span: 8 }} form={form} className="schedule-form" name="shForm" >
                    <Row gutter={20}>
                      ...
                      <Col span={span}>
                        <FormItem label="收集催收提醒:" name="sjcstx" initialValue={dakStore.DakData.sjcstx === 'Y'}>
                      ...
                      <Col span={span}>
                        <FormItem
                            label="长期保持电子中心留痕:"
                            name="cqbcTodzwjlh"
                            initialValue={dakStore.DakData.cqbcTodzwjlh === 'Y'}
                        >
                            <Switch checkedChildren="开启" unCheckedChildren="关闭" defaultChecked={dakStore.DakData.cqbcTodzwjlh === 'Y'} />
                        </FormItem>
                        </Col>
                    </Row>
                </Form>
